...
import static work3.MyUtil.*;
import work4.BankAccount;
...
public class Int101Homework01 {
    ...
    public static void main(String[] args) {
        ...
        work03UseOfUtilityClass(60,170,13,9,8);
   ...
   static void work03UseOfUtilityClass(double w,double h,int v1,int v2,int v3) {
       System.out.println("work03UseOfUtilityClassBMI = " + calculateBMI(w,h));
       System.out.println("work03UseOfUtilityClassaverage = " + average(v1,v2,v3));
   ...
   static void work04UseOfObjectClass() {
       ...
       bank1.withdraw(1000);
       System.out.println("account owner is "+bank1.getOwner());
       System.out.println("balance when withdraw "+bank1.getBalance());
       bank2.deposit(6000);
       System.out.println("account owner is "+bank2.getOwner());
       System.out.println("balance "+bank2.getBalance());
       bank2.withdraw(900);
       System.out.println("account owner is "+bank2.getOwner());
       System.out.println("balance when withdraw "+bank2.getBalance());
